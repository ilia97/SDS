...
namespace Core.Misc
{
    ...
    {
        public static readonly List<int> InitialInversionTable = new List<int>()
        {
        ...
        public static readonly List<int> FinalInversionTable = new List<int>()
        {
        ...
        public static readonly List<int> StraightPBox = new List<int>()
        {
        ...
        public static readonly int[][][] SBoxTable = new int[8][][]
        {
            new int[4][]
            {
        ...
        public static readonly Dictionary<int, int> ShiftTable = new Dictionary<int, int>()
        {
            { 1, 1 },
            { 2, 1 },
            { 3, 2 },
        ...
        public static readonly List<int> KeyEncodingPBoxTable = new List<int>()
        {
        ...
        public static readonly List<int> KeyEncodingTable = new List<int>()
        {
